...
ds_graphics = create_menu_page(
	["Resolution", menu_element_type.shift, change_resolution, 0, ["364 x 216","720 x 364"]],
	["Window Mode", menu_element_type.toggle, change_window_mode,1,["Fullscreen","Windowed"]] ,
	["Back", menu_element_type.page_transfer, menu_page.settings]
);

ds_controls = create_menu_page(
	["Up", menu_element_type.input, vk_up],
	["Left", menu_element_type.input, vk_left] ,
	["Right", menu_element_type.input, vk_right],
	["Down", menu_element_type.input, vk_down],
	["Attack", menu_element_type.input, vk_shift],
	["Use", menu_element_type.input, vk_space],
	["Back", menu_element_type.page_transfer, menu_page.settings]
);
